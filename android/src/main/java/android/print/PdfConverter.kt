        ...
        try {
            mContext?.let { context ->
                mWebView = WebView(context).apply {
                    ...
                    // --- INJETANDO CSS @page PARA MARGINS EM CADA PÁGINA ---
                    mHtmlString?.let { html ->
                        val htmlWithMargins = """
                            <html>
                                ...
                                <style>
                                    @page {
                                        margin: 40px 30px; /* top/bottom 40px, left/right 30px */
                                    }
                                    body {
                                        margin: 0;
                                        padding: 0;
                                        background-color: white; /* aqui define o fundo branco */
                                    }
                                </style>
                        ...
                        loadDataWithBaseURL(mBaseURL, htmlWithMargins, "text/HTML", "utf-8", null)
                    }
                }
            }
        } catch (e: Exception) {
